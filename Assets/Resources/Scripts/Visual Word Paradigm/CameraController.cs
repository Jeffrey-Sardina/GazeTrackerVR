...
public class CameraController : MonoBehaviour
{
    ...
    const string FIXATION_DOT = "FixationDot",
        READY_DOT = "ReadyDot";
    readonly Vector3 QI = new Vector3(12, 8, 0),
        QII = new Vector3(-12, 8, 0),
        QIV = new Vector3(12, -8, 0),
        QIII = new Vector3(-12, -8, 0);
    ...
    void InitStimuliList()
    {
        ...
        TextAsset data = Resources.Load<TextAsset>("Visual Word Paradigm/experimental_data/" + experimentSpecificationsFileName);
    ...
    GameObject DisplayFixationDot(Vector3 location, string name)
    {
        ...
        GameObject dot = Instantiate(Resources.Load<GameObject>("Visual Word Paradigm/" + FIXATION_DOT));
        dot.name = name;
    ...
    GameObject DisplayBackgroundPlane(Vector3 location)
    {
        ...
        GameObject backgroudPlane = Instantiate(Resources.Load<GameObject>("Visual Word Paradigm/BackgroundPlanePrefab"));
    ...
    GameObject DisplayImage(string imageFileName, Vector3 location, float scale, string path = "Visual Word Paradigm/stimuli/images/")
    {
        //Instantiate the prefab plane for displaying images and set its loccation
        GameObject imagePlane = Instantiate(Resources.Load<GameObject>("Visual Word Paradigm/ImagePlanePrefab"));
    ...
    {
        //Instantiate the prefab plane for displaying images and set its loccation
        thankYou = Instantiate(Resources.Load("Visual Word Paradigm/Thank_You") as GameObject);
    ...
    void PlayAudio()
    {
        ...
        audioSource.clip = Resources.Load<AudioClip>("Visual Word Paradigm/stimuli/sounds/" + audioName);
        audioSource.Play();
    }
    ...
    { 
        ...
        if (Physics.Raycast(ray, out RaycastHit hit))
        {
            ...
            else if (hit.transform.name.StartsWith(READY_DOT))
            {
                ...
                {
                    Log("Update: Callibration (with the ready dot) completed: playing audio");
    ...
    bool RunStartUp()
    {
        if(text == null)
        {
            text = Instantiate(Resources.Load("Visual Word Paradigm/trainingText") as GameObject);
    ...
    bool RunTrainingOver()
    {
        if (text == null)
        {
            text = Instantiate(Resources.Load("Visual Word Paradigm/studyText") as GameObject);
            text.transform.position = DISPLAY_LOCATION;
        }
